...
def gateway(
    ...
    agent = AgentLoop(
        ...
        memory_tokens=config.agents.defaults.memory_tokens,
        memory_keep_last=config.agents.defaults.memory_keep_last,
...
def status():
    ...
    if config_path.exists():
        ...
        console.print(f"  memory_tokens: {config.agents.defaults.memory_tokens:,}")
        console.print(f"  memory_keep_last: {config.agents.defaults.memory_keep_last}")
        console.print(f"  memory_window: {config.agents.defaults.memory_window}")
